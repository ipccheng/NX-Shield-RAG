...
Single script, multiple instances via launchd:
  NX_Shield: python3 universal_gateway_mcp.py --port 8010 --identity nutanix_shield
  Sam:       python3 universal_gateway_mcp.py --port 8011 --identity sam

All waterfall logic lives in nutanix_rag_search.py — this file is purely an HTTP adapter.
"""
import json
import sys
import asyncio
...
if __name__ == "__main__":
    import uvicorn
    print(f"[gateway] Starting universal_gateway_mcp.py — identity={AGENT_IDENTITY}, port={AGENT_PORT}, rerank_top={RERANK_TOP}")
